...
#                script (type 'fifo_42.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_42 xil_defaultlib.glbl -o fifo_42_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_42_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_42_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_42_simv.daidir vcs_lib c.obj)
