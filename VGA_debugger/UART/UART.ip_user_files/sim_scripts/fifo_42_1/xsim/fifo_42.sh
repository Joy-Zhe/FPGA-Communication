...
#
# Script generated by Vivado on Mon Feb 05 00:18:21 +0800 2024
...
#
# Usage        : fifo_42.sh
#                fifo_42.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_42.sh [-reset_run]
#                fifo_42.sh [-reset_log]
#                fifo_42.sh [-help]
#
...
# script info
echo -e "fifo_42.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_42.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_42 xil_defaultlib.fifo_42 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_42 -key {Behavioral:sim_1:Functional:fifo_42} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_42.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_42.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_42.sh [-help]\n\
Usage: fifo_42.sh [-step]\n\
Usage: fifo_42.sh [-lib_map_path]\n\
Usage: fifo_42.sh [-reset_run]\n\
Usage: fifo_42.sh [-reset_log]\n\
Usage: fifo_42.sh [-keep_index]\n\
Usage: fifo_42.sh [-noclean_files]\n\n\
